...
public class GlslParserImpl {
    ...
    public static final Pattern VERSION_PATTERN = Pattern.compile("#version\\s+(\\d+)\\s*(\\w+)?");
    ...
    public static String preprocess(final String input, final Map<String, String> macros) throws LexerException {
        ...
        try {
            ...
            return UNSTRIP_PATTERN.matcher(processedSource.toString()).replaceAll("");
        } catch (IOException e) {
...
//        function_call DEC_OP
            ...
            if (functionCall != null) {
                ...
                if (reader.tryConsume(GlslLexer.TokenType.LEFT_BRACKET)) {
                    ...
                    if (integerExpression != null && reader.tryConsume(GlslLexer.TokenType.RIGHT_BRACKET)) {
                        functionCall = new GlslGetArrayNode(functionCall, integerExpression);
                ...
                if (reader.tryConsume(GlslLexer.TokenType.DOT, GlslLexer.TokenType.IDENTIFIER)) {
                    ...
                    return new GlslGetFieldNode(functionCall, fieldSelection.toString());
                }
                reader.setCursor(functionCursor);
        ...
        while (primaryExpression != null) {
            ...
            if (reader.tryConsume(GlslLexer.TokenType.LEFT_BRACKET)) {
                GlslNode integerExpression = parseIntegerExpression(reader);
                if (integerExpression != null && reader.tryConsume(GlslLexer.TokenType.RIGHT_BRACKET)) {
                    primaryExpression = new GlslGetArrayNode(primaryExpression, integerExpression);
                    continue;
                }
            }
            ...
            if (reader.tryConsume(GlslLexer.TokenType.DOT, GlslLexer.TokenType.IDENTIFIER)) {
                ...
                primaryExpression = new GlslGetFieldNode(primaryExpression, fieldSelection.toString());
                continue;
            }
            reader.setCursor(expressionCursor);
            // primary_expression INC_OP
    ...
    public static @Nullable GlslNode parseIntegerExpression(final GlslTokenReader reader) {
        ...
        if (expression.size() != 1) {
            reader.markError("Expected exactly 1 expression, got " + expression.size());
            return null;
        }
    ...
    public static @Nullable GlslNode parseConditionalExpression(final GlslTokenReader reader) {
        ...
        if (reader.tryConsume(GlslLexer.TokenType.QUESTION)) {
            List<GlslNode> first = parseExpression(reader);
            if (first != null && reader.tryConsume(GlslLexer.TokenType.COLON)) {
                GlslNode branch = parseAssignmentExpression(reader);
                if (branch != null) {
                    return new GlslConditionalNode(logicalOr, GlslNode.compound(first), branch);
                }
            }
        }
    ...
    public static @Nullable List<GlslNode> parseDeclaration(final GlslTokenReader reader) {
        ...
        if (reader.tryConsume(GlslLexer.TokenType.IDENTIFIER, GlslLexer.TokenType.LEFT_BRACE)) {
            ...
            if (structFields != null) {
                if (reader.tryConsume(GlslLexer.TokenType.RIGHT_BRACE)) {
                    GlslSpecifiedType structSpecifier = new GlslSpecifiedType(GlslTypeSpecifier.struct(identifier, structFields), typeQualifier);

                    // type_qualifier IDENTIFIER LEFT_BRACE struct_declaration_list RIGHT_BRACE SEMICOLON
                    if (reader.tryConsume(GlslLexer.TokenType.SEMICOLON)) {
                        return Collections.singletonList(new GlslStructDeclarationNode(structSpecifier));
                    }
                    ...
                    if (reader.tryConsume(GlslLexer.TokenType.IDENTIFIER)) {
                        ...
                        // type_qualifier IDENTIFIER LEFT_BRACE struct_declaration_list RIGHT_BRACE IDENTIFIER SEMICOLON
                        if (reader.tryConsume(GlslLexer.TokenType.SEMICOLON)) {
                            return Collections.singletonList(new GlslNewFieldNode(structSpecifier, label, null));
                        }
                        ...
                        if (arraySpecifier != null && reader.tryConsume(GlslLexer.TokenType.SEMICOLON)) {
                            return Collections.singletonList(new GlslNewFieldNode(arraySpecifier, label, null));
                        }
                    }
                }
                reader.markError("Expected '}'");
        ...
        // type_qualifier SEMICOLON
        if (reader.tryConsume(GlslLexer.TokenType.SEMICOLON)) {
            return Collections.singletonList(new GlslVariableDeclarationNode(typeQualifier, Collections.emptyList()));
        }
        ...
        if (typeSpecifier != null) {
            ...
            return identifiers.stream().map(name -> (GlslNode) new GlslNewFieldNode(type, name, null)).toList();
        }
    ...
    public static @Nullable GlslParameterDeclaration parseParameterDeclaration(final GlslTokenReader reader) {
        ...
        if (typeQualifiers != null) {
            ...
            if (parameterTypeSpecifier != null) {
                return new GlslParameterDeclaration(new GlslSpecifiedType(parameterTypeSpecifier, typeQualifiers), null);
            }
        }
        reader.setCursor(cursor);
        ...
        GlslTypeSpecifier parameterTypeSpecifier = parseTypeSpecifier(reader);
        if (parameterTypeSpecifier != null) {
            return new GlslParameterDeclaration(parameterTypeSpecifier, null);
        }
    ...
    public static @Nullable GlslNode parseSingleDeclaration(@Nullable GlslSpecifiedType fullySpecifiedType, final GlslTokenReader reader) {
        ...
        if (!reader.tryConsume(GlslLexer.TokenType.IDENTIFIER)) {
            if (fullySpecifiedType.getSpecifier().isStruct()) {
                return new GlslStructDeclarationNode(fullySpecifiedType);
            }
            return new GlslNewFieldNode(fullySpecifiedType, null, null);
        }
        ...
        if (arraySpecifier != null) {
            if (!reader.tryConsume(GlslLexer.TokenType.EQUAL)) {
                // fully_specified_type IDENTIFIER array_specifier
                return new GlslNewFieldNode(arraySpecifier, name, null);
            }

            GlslNode initializer = parseInitializer(reader);
            if (initializer != null) {
                // fully_specified_type IDENTIFIER array_specifier EQUAL initializer
                return new GlslNewFieldNode(arraySpecifier, name, initializer);
            }
        }
        reader.setCursor(cursor);
        ...
        if (reader.tryConsume(GlslLexer.TokenType.EQUAL)) {
            ...
            if (initializer != null) {
                // fully_specified_type IDENTIFIER EQUAL initializer
                return new GlslNewFieldNode(fullySpecifiedType, name, initializer);
            }
        }
    ...
    public static @Nullable GlslTypeQualifier parseLayoutQualifier(final GlslTokenReader reader) {
        ...
        while (reader.canRead()) {
            ...
            if (reader.tryConsume(GlslLexer.TokenType.IDENTIFIER)) {
                ...
                qualifier = GlslTypeQualifier.layoutId(identifier, expression);
            }

            if (qualifier == null && reader.tryConsume(GlslLexer.TokenType.SHARED)) {
                qualifier = GlslTypeQualifier.LayoutId.SHARED;
            }
    ...
    public static @Nullable GlslTypeQualifier parseStorageQualifier(final GlslTokenReader reader) {
        ...
        if (reader.tryConsume(GlslLexer.TokenType.SUBROUTINE)) {
            ...
            return GlslTypeQualifier.storage();
        }
    ...
    public static @Nullable GlslNode parseSelectionStatement(final GlslTokenReader reader) {
        ...
        if (reader.tryConsume(GlslLexer.TokenType.ELSE)) {
            ...
            if (otherStatements != null) {
                return new GlslIfNode(expression, statements, otherStatements);
            }
    ...
    public static @Nullable GlslNode parseCondition(final GlslTokenReader reader) {
        ...
        if (type != null && reader.tryConsume(GlslLexer.TokenType.IDENTIFIER, GlslLexer.TokenType.EQUAL)) {
            ...
            GlslNode initializer = parseInitializer(reader);
            if (initializer != null) {
                return new GlslNewFieldNode(type, name, initializer);
            }
        }
    ...
    public static @Nullable GlslNode parseIterationStatement(final GlslTokenReader reader) {
        ...
        if (reader.tryConsume(GlslLexer.TokenType.WHILE, GlslLexer.TokenType.LEFT_PAREN)) {
            ...
            if (condition != null && reader.tryConsume(GlslLexer.TokenType.RIGHT_PAREN)) {
                ...
                if (body != null) {
                    return new GlslWhileLoopNode(condition, body, GlslWhileLoopNode.Type.WHILE);
                }
            }
        }
        reader.setCursor(cursor);
        ...
        if (reader.tryConsume(GlslLexer.TokenType.DO)) {
            ...
            if (body != null && reader.tryConsume(GlslLexer.TokenType.WHILE, GlslLexer.TokenType.LEFT_PAREN)) {
                ...
                if (condition != null && reader.tryConsume(GlslLexer.TokenType.RIGHT_PAREN, GlslLexer.TokenType.SEMICOLON)) {
                    return new GlslWhileLoopNode(condition, body, GlslWhileLoopNode.Type.DO);
                }
            }
        }
        reader.setCursor(cursor);
            ...
            if (init != null) {
                ...
                if (condition != null && reader.tryConsume(GlslLexer.TokenType.SEMICOLON)) {
                    ...
                    if (reader.tryConsume(GlslLexer.TokenType.RIGHT_PAREN)) {
                        List<GlslNode> body = parseStatementNoNewScope(reader);
                        if (body != null) {
                            return new GlslForLoopNode(init, condition, increment, body);
                        }
                    }
                }
            }
